...
const NotFound = () => {
  ...
  return (
    <>
      ...
      <div className='z-50'>
        <div className="absolute top-1/5 left-1/10 w-15 h-15 bg-Black bg-opacity-10 rounded-full opacity-10 animate-float-delay-1" />
        <div className="absolute top-3/5 right-1/6 w-10 h-10 bg-Black bg-opacity-10 opacity-10 animate-float-delay-2 transform rotate-45" />
        <div className="absolute bottom-1/5 left-1/5 w-20 h-20 bg-Black bg-opacity-10 opacity-10 animate-float-delay-3 rounded-2xl" />
        <div 
          className="absolute top-1/3 right-1/3 w-8 h-8 bg-Black bg-opacity-10 opacity-10 animate-float-delay-4"
